...
public class frmAddProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ckIndeterminada = new javax.swing.JCheckBox();
        ...
        ckIndeterminada.setText("Indeterminada");
        ckIndeterminada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ckIndeterminadaMouseClicked(evt);
            }
        });
        ckIndeterminada.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ckIndeterminadaActionPerformed(evt);
            }
        });
        ckIndeterminada.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ckIndeterminadaKeyPressed(evt);
            }
        });
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if(param.equals("cadastrar")){
            ...
            try {
               ...
               if (consultaproduto.getIdBCod(txtCodigo.getText())<0){
                    ...
                    prod.cadastrar(0, txtCodigo.getText(),
                                      ...
                                      ckIndeterminada.isSelected()?"indeterminada":txtValidade.getText(),
                   ...
                   int duplicidadeCodigo = JOptionPane.showConfirmDialog (null, "Codigo do produto já cadastrado, deseja alterar código desse cadastro?","Código já em uso",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
            ...
            try{
                ...
                if (ckIndeterminada.isSelected()) {
                    txtValidade.setText("Indeterminada");
                }
    ...
    private void ckIndeterminadaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckIndeterminadaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ckIndeterminadaActionPerformed

    private void ckIndeterminadaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ckIndeterminadaKeyPressed
        txtValidade.enable();
    }//GEN-LAST:event_ckIndeterminadaKeyPressed

    private void ckIndeterminadaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ckIndeterminadaMouseClicked
        if (ckIndeterminada.isSelected()) {
             txtValidade.setEnabled(false);
        } else {
             txtValidade.setEnabled(true);
        }
    }//GEN-LAST:event_ckIndeterminadaMouseClicked
    ...
    private javax.swing.JCheckBox ckIndeterminada;
